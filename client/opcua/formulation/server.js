...
async function main() {
    ...
    try {
        ...
        const endpointUrl = "opc.tcp://server5.pharmatech.local:26543/UA/FormulationServer";
        ...
        async function readVariable(nodeId, variableName) {
            try {
                ...
                insertOrUpdateRecord(db, variableName, 'formulation', 'OPC UA', value, nodeId);
            } catch (error) {
        ...
        const nodesToRead = [
            ...
            { nodeId: "ns=1;i=1005", variableName: "Humidity" },
            { nodeId: "ns=1;i=1007", variableName: "ProductLevel" },
        ];
...
//             "ns=1;i=1005", // Humidity
//             "ns=1;i=1007", // ProductLevel
